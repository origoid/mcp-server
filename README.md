...
| `extract_curp_document` | `POST /mex/renapo/v1/curp-documents` |
...
| `validate_cep` | `POST /mex/banking/v1/cep-validations` |
...
| `get_issste_record` | `POST /mex/social-security/v1/issste-records` |
